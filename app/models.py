...
class MyUser(AbstractBaseUser):
    ...
    user_type = models.CharField(
        choices=USER_TYPE_CHOICES, max_length=64, default='author')
...
class Journal(models.Model):
    ...
    j_image = models.ImageField(
        upload_to='j_images', height_field=None, width_field=None,)
...
class Article(models.Model):
    ...
    state = models.CharField(
        max_length=15, choices=STAGE_CHOICES, default=STAGE_UNSUBMITTED)
...
class EditorNote(models.Model):
    article = models.ForeignKey(
        Article, on_delete=models.CASCADE, related_name='Editornotes')
